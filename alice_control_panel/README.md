...
- Version `0.1.101` adds persistent panel fallback for the ESP speaker-volume slider; the existing quiet gain maps to 50% and reboot restores the saved level.
