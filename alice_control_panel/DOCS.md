...
- `0.1.3` runs `app.minimal_server` with Python standard library only. This is intentional install smoke mode; FastAPI, provider streaming, and STT packages are re-enabled after the add-on reliably installs.
