...
- `0.1.7` runs the lightweight FastAPI backend with the revised dashboard layout: logs are high-priority, prompts sit above config, and config stays at the bottom.
