...
Varsayilan endpointing provider `silero`dur. `silero-vad-lite` ONNX tabanli Silero VAD kullanir ve 16 kHz akista
32 ms'lik pencerelerle konusma olasiligi uretir. Paket yuklenemezse add-on otomatik olarak eski enerji tabanli
fallback endpointing'e duser.
